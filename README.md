...
**To increment now:** Actions → Update Counter → Run workflow (leave input empty).

Schedule: every 5 minutes (GitHub limit). For **view-based** increment, use Option 1 (Worker) or Option 2 (Moe-Counter).
